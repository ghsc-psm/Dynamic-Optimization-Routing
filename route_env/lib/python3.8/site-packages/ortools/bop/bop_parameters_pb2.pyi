...
class BopOptimizerMethod(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        type: typing.Optional[global___BopOptimizerMethod.OptimizerType.ValueType] = ...,
        ) -> None: ...
...
class BopSolverOptimizerSet(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        methods: typing.Optional[typing.Iterable[global___BopOptimizerMethod]] = ...,
        ) -> None: ...
...
class BopParameters(google.protobuf.message.Message):
    ...
    def solver_optimizer_sets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___BopSolverOptimizerSet]:
        ...
        """
        pass
    default_solver_optimizer_sets: typing.Text
    ...
    def __init__(self,
        *,
        ...
        lp_max_deterministic_time: typing.Optional[builtins.float] = ...,
        max_number_of_consecutive_failing_optimizer_calls: typing.Optional[builtins.int] = ...,
        relative_gap_limit: typing.Optional[builtins.float] = ...,
        max_num_decisions_in_ls: typing.Optional[builtins.int] = ...,
        max_num_broken_constraints_in_ls: typing.Optional[builtins.int] = ...,
        log_search_progress: typing.Optional[builtins.bool] = ...,
        compute_estimated_impact: typing.Optional[builtins.bool] = ...,
        prune_search_tree: typing.Optional[builtins.bool] = ...,
        sort_constraints_by_num_terms: typing.Optional[builtins.bool] = ...,
        use_random_lns: typing.Optional[builtins.bool] = ...,
        random_seed: typing.Optional[builtins.int] = ...,
        num_relaxed_vars: typing.Optional[builtins.int] = ...,
        max_number_of_conflicts_in_random_lns: typing.Optional[builtins.int] = ...,
        num_random_lns_tries: typing.Optional[builtins.int] = ...,
        max_number_of_backtracks_in_ls: typing.Optional[builtins.int] = ...,
        use_lp_lns: typing.Optional[builtins.bool] = ...,
        use_sat_to_choose_lns_neighbourhood: typing.Optional[builtins.bool] = ...,
        max_number_of_conflicts_for_quick_check: typing.Optional[builtins.int] = ...,
        use_symmetry: typing.Optional[builtins.bool] = ...,
        exploit_symmetry_in_sat_first_solution: typing.Optional[builtins.bool] = ...,
        max_number_of_conflicts_in_random_solution_generation: typing.Optional[builtins.int] = ...,
        max_number_of_explored_assignments_per_try_in_ls: typing.Optional[builtins.int] = ...,
        use_transposition_table_in_ls: typing.Optional[builtins.bool] = ...,
        use_potential_one_flip_repairs_in_ls: typing.Optional[builtins.bool] = ...,
        use_learned_binary_clauses_in_lp: typing.Optional[builtins.bool] = ...,
        number_of_solvers: typing.Optional[builtins.int] = ...,
        synchronization_type: typing.Optional[global___BopParameters.ThreadSynchronizationType.ValueType] = ...,
        solver_optimizer_sets: typing.Optional[typing.Iterable[global___BopSolverOptimizerSet]] = ...,
        default_solver_optimizer_sets: typing.Optional[typing.Text] = ...,
        use_lp_strong_branching: typing.Optional[builtins.bool] = ...,
        decomposer_num_variables_threshold: typing.Optional[builtins.int] = ...,
        num_bop_solvers_used_by_decomposition: typing.Optional[builtins.int] = ...,
        decomposed_problem_min_time_in_seconds: typing.Optional[builtins.float] = ...,
        guided_sat_conflicts_chunk: typing.Optional[builtins.int] = ...,
        max_lp_solve_for_feasibility_problems: typing.Optional[builtins.int] = ...,
        ) -> None: ...
