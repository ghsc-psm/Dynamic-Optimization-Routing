...
_BOPOPTIMIZERMETHOD = DESCRIPTOR.message_types_by_name['BopOptimizerMethod']
_BOPSOLVEROPTIMIZERSET = DESCRIPTOR.message_types_by_name['BopSolverOptimizerSet']
_BOPPARAMETERS = DESCRIPTOR.message_types_by_name['BopParameters']
_BOPOPTIMIZERMETHOD_OPTIMIZERTYPE = _BOPOPTIMIZERMETHOD.enum_types_by_name['OptimizerType']
_BOPPARAMETERS_THREADSYNCHRONIZATIONTYPE = _BOPPARAMETERS.enum_types_by_name['ThreadSynchronizationType']
BopOptimizerMethod = _reflection.GeneratedProtocolMessageType('BopOptimizerMethod', (_message.Message,), {
  'DESCRIPTOR' : _BOPOPTIMIZERMETHOD,
  '__module__' : 'ortools.bop.bop_parameters_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.bop.BopOptimizerMethod)
  })
_sym_db.RegisterMessage(BopOptimizerMethod)

BopSolverOptimizerSet = _reflection.GeneratedProtocolMessageType('BopSolverOptimizerSet', (_message.Message,), {
  'DESCRIPTOR' : _BOPSOLVEROPTIMIZERSET,
  '__module__' : 'ortools.bop.bop_parameters_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.bop.BopSolverOptimizerSet)
  })
_sym_db.RegisterMessage(BopSolverOptimizerSet)

BopParameters = _reflection.GeneratedProtocolMessageType('BopParameters', (_message.Message,), {
  'DESCRIPTOR' : _BOPPARAMETERS,
  '__module__' : 'ortools.bop.bop_parameters_pb2'
  # @@protoc_insertion_point(class_scope:operations_research.bop.BopParameters)
  })
_sym_db.RegisterMessage(BopParameters)

if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n\026com.google.ortools.bopP\001\252\002\022Google.OrTools.Bop'
  _BOPOPTIMIZERMETHOD._serialized_start=62
  _BOPOPTIMIZERMETHOD._serialized_end=578
  _BOPOPTIMIZERMETHOD_OPTIMIZERTYPE._serialized_start=158
  _BOPOPTIMIZERMETHOD_OPTIMIZERTYPE._serialized_end=578
  _BOPSOLVEROPTIMIZERSET._serialized_start=580
  _BOPSOLVEROPTIMIZERSET._serialized_end=665
  _BOPPARAMETERS._serialized_start=668
  _BOPPARAMETERS._serialized_end=3210
  _BOPPARAMETERS_THREADSYNCHRONIZATIONTYPE._serialized_start=3112
  _BOPPARAMETERS_THREADSYNCHRONIZATIONTYPE._serialized_end=3210
