...
class RoutingSearchParameters(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        continuous_scheduling_solver: global___RoutingSearchParameters.SchedulingSolver.ValueType = ...,
        mixed_integer_scheduling_solver: global___RoutingSearchParameters.SchedulingSolver.ValueType = ...,
        disable_scheduling_beware_this_may_degrade_performance: typing.Optional[builtins.bool] = ...,
        optimization_step: builtins.float = ...,
        number_of_solutions_to_collect: builtins.int = ...,
        solution_limit: builtins.int = ...,
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_disable_scheduling_beware_this_may_degrade_performance",b"_disable_scheduling_beware_this_may_degrade_performance"]) -> typing.Optional[typing_extensions.Literal["disable_scheduling_beware_this_may_degrade_performance"]]: ...
